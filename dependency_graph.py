...
def create_graph(folder, create_cluster, label_cluster, strict, include_tests):
...
if __name__ == '__main__':
	...
	parser.add_argument('-t', '--tests', action='store_true', help='True if want to include test files else False', default=True)
	...
	graph = create_graph(args.folder, args.cluster, args.cluster_labels, args.strict, args.tests)
